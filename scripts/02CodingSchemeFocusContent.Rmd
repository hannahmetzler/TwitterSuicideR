...
Tweets per category if 1st and 3rd person perspective are combined for Coping and Suicidality, and news coping and news suicidality classes included as well. Total number of tweets n=`r sum(prop.comb$n,2)`.  
```{r}
