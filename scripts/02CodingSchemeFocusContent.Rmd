...
# Add 1000 randomly selected tweets to hand- and model-selected training set. Labels for focus/narrative and type of content.

```{r}
training <- read.csv('../tweet_training_set/training_posts20201102_2185tweets.tsv', sep='\t') %>%  #training sample according to table with 6 content types and 2 narratives
  select(-txt_clean)
