...
# Performance scores with confidence intervals for all machine learning models: BERT
...
val_6cat = read.csv('../results/predictions_BERT_6_classes_validation_set_notext.csv')
test_6cat = read.csv('../results/predictions_BERT_6_classes_test_set_notext.csv')
...
val_6cat = read.csv('../results/predictions_XLNET_6_classes_validation_set.csv')
test_6cat = read.csv('../results/predictions_XLNET_6_classes_test_set_notext.csv')
val_aboutsuicide = read.csv('../results/predictions_XLNET_about_suicide_validation_set_notext.csv')
test_aboutsuicide = read.csv('../results/predictions_XLNET_about_suicide_test_set_notext.csv')
```
