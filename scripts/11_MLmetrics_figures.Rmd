...
```{r, BERT 2 intraclass 6 classes per metric, cache=T, fig.height=4.5, fig.width=6}
...
plotabout
ggsave('../figures/Figure_BERT_intraclass_about_suicide.pdf', plotabout, width=4.5, height=7, dpi=300)
```
...
combined = ggarrange(plotm, plotabout, ncol=1, nrow=2, align = "hv",
